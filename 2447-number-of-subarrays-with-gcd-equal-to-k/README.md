...
<pre style="position: relative;"><strong>Input:</strong> nums = [9,3,1,2,6,3], k = 3
...
<pre style="position: relative;"><strong>Input:</strong> nums = [4], k = 7
